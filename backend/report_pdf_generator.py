    ...
    try:
        ...
        if not findings:
            ...
            for f in findings:
                ...
                cvss = str(f.get("cvss_score") or f.get("cvss") or "N/A")
        ...
        if not findings:
            ...
            for idx, f in enumerate(findings):
                ...
                cvss_score = f.get("cvss_score") or f.get("cvss") or "N/A"
                ...
                f_hdr = [
                    [
                        ...
                        Paragraph(f"<b>{sev}</b> (CVSS {cvss_score})", ParagraphStyle('FSev', fontName='Helvetica-Bold', fontSize=9, textColor=colors.white, alignment=2, leading=12))
                    ]
                ]
                ...
                f_meta = [
                    ...
                    [
                        ...
                        Paragraph(_escape(cvss_vector) if cvss_vector else f"Base {cvss_score}", style_table_cell)
                    ]
                ]
